            ...
            <table className="w-full border">
                ...
                <tbody>
                    {employer.map((employer) => (
                        <tr key={employer.id} className="border">
                            <td className="flex justify-center p-2">
                                <Typography variant="small" color="blue-gray">
                                    <Avatar src="https://static1.personality-database.com/profile_images/eb2e522547a24f55af735972a546e0a4.png" />
                                </Typography>
                            </td>
                            <td className="p-2">
                                <Typography variant="small" color="blue-gray">
